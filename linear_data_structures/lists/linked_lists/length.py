# To implement the length method, we need to use a technique known as linked list traversal.
# Traversal refers to the process of systematically visiting each node. To do this we use an
